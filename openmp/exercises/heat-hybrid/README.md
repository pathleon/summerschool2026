...
which is to be extended to hybrid MPI+OpenMP parallelization.

The provided initial code is the "solution-collective" variant from the MPI section.
You are welcome to keep working on your own MPI heat equation in this exercise.

1. Initialize MPI with appropriate thread safety level
2. Determine and print the number of threads in the main routine ([cpp/main.cpp](cpp/main.cpp) or [fortran/main.F90](fortran/main.F90))
